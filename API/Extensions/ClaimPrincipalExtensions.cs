...
public static class ClaimPrincipalExtensions
{
    public static async Task<AppUser> GetUserByEmail(this UserManager<AppUser> userManager, ClaimsPrincipal user)
    {
        ...
        if (userToReturn == null) throw new AuthenticationException("Usuário não encontrado.");
    ...
    {
        var email = user.FindFirstValue(ClaimTypes.Email) ?? throw new AuthenticationException("Email não encontrado.");
